...
## might need to add libpath for 'countreg'
# .libPaths(c("/cluster/home/t110409uhn/R/x86_64-pc-linux-gnu-library/4.2"))

suppressMessages(library(arrow))
suppressMessages(library(tidyverse))
suppressMessages(library(MASS))
suppressMessages(library(flexmix))
suppressMessages(library(countreg))
...
# args = list()
# args[['input']] = "./outputs/bedpe_bin_stats_GSM5067062_2020_6544_human_bedpe.1000lines.feather"
